...
- Macros & Nutrition Tracking : The application calculates personalized macronutrient targets (Protein, Carbs, and Fats) and daily calorie needs using the Mifflin-St Jeor Formula for BMR and activity-based TDEE.
...
- Animations     : Custom CSS animations for a smooth, interactive user experience.

---
How It Works
1. Onboarding   : Users create a secure account and provide vital stats (age, weight, height, activity level).
